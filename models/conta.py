...
class Conta:
    ...
    def depositar(self: object, valor: float) -> None:
        if valor > 0:
            ...
            print('Error ao efetuar o deposito, valor invalido')
    ...
    def sacar(self: object, valor: float) -> None:
        if valor > 0 and self.saldo_total >= valor:
            ...
            if self.saldo >= valor:
                self.saldo = self.saldo - valor
                self.saldo_total = self.calcula_saldo_total
                print(f'Saque realizado com sucesso, seu saldo atual é {self.saldo_total}')
                ...
                self.saldo_total = self.calcula_saldo_total
                print(f'Saque realizado, seu saldo atual é {self.saldo_total} ')


        else:
            print('Error ao efetuar o saque. Tente novamente')
    ...
    def transferir(self: object, destino: object, valor: float) -> None:
        if valor > 0 and self.saldo_total >= valor:
            ...
            print('Error ao efetuar transferencia, valor invalido')